...
<head>
    ...
    <title>@yield('title') - Eco Farm</title>
    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        {{-- <a href="{{ route('auth.login') }}"><img src="{{ asset('images/logo_desa_cakrawala.png') }}" alt="Logo"></a> --}}
                    </div>
                    <h1 class="auth-title">Log in.</h1>
                    <p class="auth-subtitle mb-5">Selamat data di website admin desacakrawala, Login untuk melanjutkan</p>

                    <form action="{{ route('auth.login') }}" method="POST">
                        @csrf
                        @error('username')
                            <small class="text-danger text-capitalize mb-1 pl-3 d-block" style="text-align: left; font-size: 1em">{{ $message }}</small>
                        @enderror
